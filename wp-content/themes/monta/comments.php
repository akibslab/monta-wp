...
<div id="comments" class="comments-area default-max-width <?php echo get_option('show_avatars') ? 'show-avatars' : ''; ?>">
   ...
   if (have_comments()) : ?>
      ...
      if (!comments_open()) : ?>
         <p class="no-comments"><?php esc_html_e('Comments are closed.', 'monta'); ?></p>
   <?php
      endif;
   ...
   comment_form([
      ...
      'comment_notes_before' => sprintf(
         ...
         sprintf('<span id="email-notes">%s</span>', __('Your email address will not be published.', 'monta')),
         sprintf('<span class="required-field-message">%s <span class="required" >%s</span></span>', __('Required fields are marked', 'monta'), __('*', 'monta'))
      ),
